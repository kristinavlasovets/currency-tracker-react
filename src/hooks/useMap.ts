...
export const useMap = (searchCode: string) => {
  ...
  useEffect(() => {
    const map = new Map({
      ...
      style: `https://api.maptiler.com/maps/streets/style.json?key=${envVariables.maptilerApiKey}`,
